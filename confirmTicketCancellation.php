...
$confirmcancel=$client-> confirmTicketCancellation("javaapitest","testing","TGE2OK80803",array("M3")); 
print "<pre>";
print_r($confirmcancel);
print "</pre>";
//$arr=$confirmcancel->stationList; 
?>
...
<?php 						
$cancellation = $confirmcancel->refundAmount;
print "<pre>";
print_r($confirmcancel);
print "</pre>";
