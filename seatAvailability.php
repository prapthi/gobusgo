...
?>
<div class="seability">
<table width="261" height="121" cellspacing="2" cellpadding="0" border="0" class="tabouter">
<tr>
	<td class="boardtab">
			<ul class="board">
...
krsort($rows);
?>
<table width="595" height="199" cellspacing="2" cellpadding="0" border="0"> <!--outer table -->
	<tr><!--first tr ---->
	...
	<tr><!-- third tr-->
	<td valign="top" align="right" rowspan="6" colspan="3">	<!--second td tbody ---->	
