...
$getList=$client->getStationList("javaapitest","testing"); 
$ResGetList=$getList->stationList; 
?>
...
print_r($ResGetList);
print "</pre>";
foreach ( $ResGetList as $term ) {  
$satationid = $term->stationId; 
$stationname = $term->stationName; 
$stationname = ucwords($stationname);
}
?>				
