...
$bookTickets= $client->BookTicket("javaapitest","testing","TGE35K81470");
print "<pre>";
print_r($bookTickets);
print "</pre>";
?>
...
$bookId = $bookTickets->bookingId;	
$cancelList = $bookTickets->cancellationDescList;
$extraList = $bookTickets->extraSeatInfoList;	
$travelNos = $bookTickets->travelsPhoneNbr;

print "<pre>";
print_r($extraList);
print "</pre>";

foreach($extraList as $value){
